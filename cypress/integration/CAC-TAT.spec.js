...
beforeEach(function(){
  ...
  it('exibe mensagem de erro ao submeter o formulário com um email com formatação inválida', function(){
    cy.get('#firstName').type('Emerson')
    cy.get('#lastName').type('Rodrigues')
    cy.get('#email').type('testeemerson,.com')
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function(){
    ...
    cy.get('#lastName')
      ...
      .should('have.value', '')
    cy.get('#email')
      .type('testeemerson@gmail.com')
      .should('have.value', 'testeemerson@gmail.com')
      .clear()
      .should('have.value', '')
    cy.get('#phone')
      .type('1234567890')
  ...
  it('marca o tipo de atendimento', function(){
    cy.get('input[type="radio"]')
      ...
      .each(function($radio){
        cy.wrap($radio).check() //empacota e verifica cada um deles
